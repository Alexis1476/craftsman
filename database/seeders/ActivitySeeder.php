    ...
    public function run()
    {
        ...
        Activity::factory()->createMany([[
            ...
            'why' => 'C\'est un outil extrêmement important pour aider à l’amélioration de
                        chacun.<br> Soyez spécifique, essayez de faire un lien positif avec un comportement
                        et un résultat.',
            'points' => 3,
            'laboratory' => 'INF',
            'category_id' => $culture->id
            ...
            'name' => 'Conference',
            'description' => 'Suivez la conférence de la section informatique.<br>
                                Les horaires:',
        ...
        Activity::factory()->createMany([[
            ...
            'why' => 'Etablir des liens / amitiés interculturelles.<br>Donner un coup de boost à notre cerveau.',
            'points' => 3,
            'laboratory' => 'INF',
        ...
        Activity::factory()->createMany([[
            ...
            'why' => 'Les systèmes de contrôle de version vous permettent de :
                        <ul>
                        <li>Comparer des fichiers.</li>
                        <li>Identifier les différences.</li>
                        <li>Fusionnez les modifications si nécessaire avant de valider un code.</li>
                        <li>Gardez une trace des versions d\'application en étant capable.</li>
        ...
        Activity::factory()->createMany([[
            ...
            'description' => 'Avec l\'aide d\'un élève, écrivez une partie de code et testez votre
                                fonctionnalité.',
            'why' => 'Un code propre est un code facile à comprendre et facile à modifier.<br>
